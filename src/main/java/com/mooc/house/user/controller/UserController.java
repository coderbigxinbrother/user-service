...
import com.mooc.house.user.exception.IllegalParamsException.Type;
import com.mooc.house.user.model.User;
import com.mooc.house.user.service.UserService;

//--spring.profiles.active=usercopy
@RestController
@RequestMapping("user")
...
//		}
	...
	//
	// logger.info("request coming....port is " + port);
	// if (id == null) {
	// throw new IllegalParamsException(Type.WRONG_PAGE_NUM, "错误的分页");
	// }
	//
	// return RestResponse.success("test-username port is " + port);
	//
	// }
}
